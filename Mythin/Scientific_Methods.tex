...
\addbibresource{/Users/lucasdubois/Desktop/LaTeX/MASTER/TEXT/master.bib}
\usepackage{setspace}
\setstretch{1.0}
\usepackage{hyperref}
\hypersetup{
...
\vfill
\begin{center}
    \textbf{Any updated can bet found in my Github Repo (\href{https://github.com/LucasDubss/Master-Dubois-Lucas}{HERE})}
\end{center}
\vfill
\pagebreak
